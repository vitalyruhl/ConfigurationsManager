...
struct CoreWiFiSettings {
  ...
  void attachTo(ConfigManagerClass& cfg) {
    ...
    staticIp.showIfFunc = [this]() { return !useDhcp.get(); };
    gateway.showIfFunc = [this]() { return !useDhcp.get(); };
    subnet.showIfFunc = [this]() { return !useDhcp.get(); };
    dnsPrimary.showIfFunc = [this]() { return !useDhcp.get(); };
    dnsSecondary.showIfFunc = [this]() { return !useDhcp.get(); };
  }
};
#endif
