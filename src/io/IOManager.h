...
public:
  ...
  LiveControlHandleBool addDigitalInputToLive(const char* id, int order, const char* pageName = "Live", const char* cardName = "Live Values", const char* groupName = nullptr, const char* labelOverride = nullptr, bool alarmWhenActive = true);
  ...
  void addAnalogInputToLive(const char* id, int order, const char* pageName = "Live", const char* cardName = "Live Values", const char* groupName = nullptr, const char* labelOverride = nullptr, bool showRaw = false);

  void addAnalogInputToLiveWithAlarm(const char* id, int order, float alarmMin, float alarmMax, AnalogAlarmCallbacks callbacks = {}, const char* pageName = "Live", const char* cardName = "Live Values", const char* groupName = nullptr, const char* labelOverride = nullptr);
  ...
  void addAnalogOutputValueToGUI(const char* id, const char* cardName, int order, const char* runtimeLabel = nullptr, const char* runtimeGroup = "controls", const char* unit = nullptr, int precision = 2);

  // Shows the raw DAC value (0..255).
  void addAnalogOutputValueRawToGUI(const char* id, const char* cardName, int order, const char* runtimeLabel = nullptr, const char* runtimeGroup = "controls");

  // Shows the current output voltage (0..3.3V).
  void addAnalogOutputValueVoltToGUI(const char* id, const char* cardName, int order, const char* runtimeLabel = nullptr, const char* runtimeGroup = "controls", int precision = 3);
  ...
  bool getStatus(const char* id) const {
    return getState(id);
  }
