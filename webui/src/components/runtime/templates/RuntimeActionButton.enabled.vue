<template>
  <div class="rw act" :data-group="group" :data-key="field.key">
    ...
    <span class="val">
      <button class="btn" type="button" @click="emitAction">{{ field.label }}</button>
    </span>
    <span class="un"></span>
  </div>
</template>
...
function emitAction(){ emit('action', { group: props.group, key: props.field.key, field: props.field }); }
</script>
