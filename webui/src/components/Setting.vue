...
<style scoped>
.setting{margin:15px 0;padding:15px;background:#f8f9fa;border-radius:5px;display:flex;flex-direction:column;gap:10px;align-items:flex-start}.bool-setting{flex-direction:row;align-items:center;justify-content:space-between;gap:1.25rem;max-width:520px}.bool-setting :deep(.rw){margin:0}.bool-setting :deep(.lab){font-weight:600;padding-right:2rem}label{font-weight:600;min-width:70px}.input-area{flex:2;display:flex;align-items:center;gap:.75rem}.input-area input[type=text],.input-area input[type=number],.input-area input[type=password]{flex:1}.actions{display:flex;flex-direction:column;gap:5px;width:100%}.actions button{padding:8px 16px;font-size:14px;border:none;border-radius:4px;cursor:pointer;transition:.3s;width:100%;margin-bottom:5px;box-shadow:0 1px 3px rgba(0,0,0,.12)}.apply-btn{background:#3498db;color:#fff}.save-btn{background:#27ae60;color:#fff}.bool-actions{width:auto;align-items:flex-end}.bool-actions button{width:auto;margin-bottom:0}input,select{width:100%;padding:8px;border:1px solid #ddd;border-radius:4px;font-size:14px;box-sizing:border-box}@media (min-width:768px){.setting{flex-direction:row;align-items:center;max-width:70%}.actions{flex-direction:row;width:auto}.actions button{width:auto}input,select{width:auto;flex:2}}
</style>
